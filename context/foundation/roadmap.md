...
- **Status:** in progress (F-01 prerequisite met; change folder `offline-first-persistence-layer` + branch `feat/offline-first-persistence-layer` created; unknowns/risk + all four open questions resolved via `research.md` — ready for `/10x-plan`)
