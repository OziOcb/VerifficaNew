...
| --- | -------------------------------- | ------------------------------------------------------------------------------------------------------------------------------ | --------------- | ------------------------------- | ------------- | ---------------------------------------------------- |
| 1   | Visibility-engine hardening      | Prove engine output matches the authored catalogue across the axis+flag matrix — a trustworthy oracle for future Smart Pruning | #2 (proxies #3) | unit + catalogue reconciliation | change opened | context/changes/testing-visibility-engine-hardening/ |
