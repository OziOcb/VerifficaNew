...
| 2   | Offline durability at flow level | Multiple offline answers + a note survive offline → reload → reconnect; the queue drains in order                              | #1              | integration + e2e               | planned     | context/changes/testing-offline-durability/                     |
