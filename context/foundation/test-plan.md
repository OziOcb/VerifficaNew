...
| 4   | workerd deployed smoke-gate      | A repeatable deployed `wrangler tail` smoke of sync/create + SW load, wired as a gate                                          | #5              | deployed smoke / CI gate        | change opened | context/changes/testing-workerd-deployed-smoke-gate/            |
