...
| 3   | Sync-endpoint server-trust       | The server boundary rejects malformed / oversized domain writes regardless of the client                                       | #6              | integration                     | change opened | context/changes/testing-sync-endpoint-server-trust/             |
