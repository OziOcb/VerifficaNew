...
- [x] 3.1 Linting passes: `npm run lint` — 563f5bb
- [x] 3.2 Production build succeeds: `npm run build` — 563f5bb
- [x] 3.3 Existing `QuestionCards`/session tests pass: `npm test` — 563f5bb
