...
- [ ] 3.1 Type check + lint pass with widened `SaveInput` + new components (`npm run lint`)
- [ ] 3.2 Existing sync/db unit tests still pass (`npm test`)
- [ ] 3.3 `astro sync` passes

#### Manual

- [ ] 3.4 `saveInspection` with config + `flushQueue` writes config columns to Supabase
