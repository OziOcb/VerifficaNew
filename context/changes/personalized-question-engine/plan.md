...
- [ ] 1.2 Type checking + lint pass: `npm run lint`
- [ ] 1.3 Production build passes (module is server-safe): `npm run build`
- [ ] 1.4 Malformed catalogue makes the Zod parse throw at module load (asserted)

#### Manual

- [ ] 1.5 Spot-check `selectVisibleGroups` for a known config against the markdown source
- [ ] 1.6 EV vs petrol visible counts differ in the expected direction
